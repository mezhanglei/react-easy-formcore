...
[![Version](https://img.shields.io/badge/version-1.1.6-green)](https://www.npmjs.com/package/react-easy-formcore)
...
- `labelAlign` `'horizontal'|'vertical'|'inline'` 所有 field 组件设置布局类型，默认值为`horizontal`。
